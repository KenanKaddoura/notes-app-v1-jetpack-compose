...
dependencies {
    ...
    implementation("androidx.lifecycle:lifecycle-viewmodel-compose:2.8.7") // ViewModel support
    implementation("androidx.navigation:navigation-compose:2.8.5") // Navigation support
    implementation("androidx.compose.material:material-icons-extended:1.7.6") // Material Icons support
    implementation("androidx.hilt:hilt-navigation-compose:1.2.0") // Hilt support for Compose

    debugImplementation("androidx.compose.ui:ui-tooling:1.7.6") // Debugging tools for Compose

    // Coroutines
    implementation("org.jetbrains.kotlinx:kotlinx-coroutines-core:1.7.1") // Coroutines core library
    implementation("org.jetbrains.kotlinx:kotlinx-coroutines-android:1.7.3") // Coroutines for Android

    //Dagger - Hilt
    // Dagger Hilt dependencies
    implementation("com.google.dagger:hilt-android:2.49") // Hilt dependency
    ...
    kapt("androidx.room:room-compiler:2.6.1") // Room compiler for annotations
    implementation("androidx.hilt:hilt-lifecycle-viewmodel:1.0.0-alpha03")
    kapt("androidx.hilt:hilt-compiler:1.2.0")

    // Kotlin Extensions and Coroutines support for Room
    implementation("androidx.room:room-ktx:2.6.1") // Kotlin extensions for Room
    implementation("androidx.room:room-paging:2.6.1") // Paging support for Room (optional)
}